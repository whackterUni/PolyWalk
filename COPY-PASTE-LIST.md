# PolyWalk - A Modern Fullstack E-Commerce Marketplace for Digital Products

Built with the Next.js 14 App Router, tRPC, TypeScript, Payload & Tailwind

![Project Image](https://github.com/joschan21/PolyWalk/blob/master/public/thumbnail.jpg)
...
<svg
    ...
    fill='currentColor'
    aria-hidden='true'
    className='ml-2 h-5 w-5 flex-shrink-0 text-white'>
...
try {
    ...
    from: 'PolyWalk <hello@joshtriedcoding.com>',
    to: [user.email],
...
<Html>
    <Head />
    <Preview>Your PolyWalk Receipt</Preview>
    ...
    <Container style={container}>
        ...
        Copyright © 2023 PolyWalk Inc. <br />{' '}
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to PolyWalk, an immersive e-commerce marketplace. Use the button below to {actionLabel}.
    </Text>
...
export function constructMetadata({
  title = 'PolyWalk - the marketplace for digital assets',
  description = 'PolyWalk is an open-source marketplace for high-quality digital goods.',
  image = '/thumbnail.png',
  icons = '/favicon.ico',
  noIndex = false,
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://PolyWalk.up.railway.app'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false,
